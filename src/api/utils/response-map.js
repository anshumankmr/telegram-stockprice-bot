...
module.exports = {
	...
	confirmResponse: 'I can help you with tracking the stock : <%= companyName %> with the Instrument ID:<%= companyId %>. Please note that the last traded price was <%= lastPrice %>.',
	signUpMessage:'Before we can proceed, I will need to verify your account in our database, so please provide us your phone number. Currently, we are invite only and we are working on adding a sign up process.',
