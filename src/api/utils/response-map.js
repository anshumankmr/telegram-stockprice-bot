...
module.exports = {
	...
	confirmResponse: 'Sure, I am going to  help with tracking the stock : <%= companyName %> with the Instrument ID:<%= companyId %>. Please note that the last traded price was <%= lastPrice %>. However, before we can proceed, I will need to verify your account in our database. Currently, we are invite only and we are working on adding a sign up process.',
